...
def main():
    ...
    parser.add_argument("--xg", type=Path, default=Path("data/processed/understat/matches.json"))
    ...
    observations = json.loads(args.xg.read_text())
    report = {
        "xg_sha256": file_hash(args.xg),
