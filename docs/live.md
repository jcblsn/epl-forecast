...
historical date convention. M2 sees only prior-date results. The season table fixes
...
Only the fixed-strength model receives a placeholder date for simulation. No
